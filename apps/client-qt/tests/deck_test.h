...
class TestDeckLibrary : public QObject
{
  ...
  private slots:
    ...
    void storesAudioPreferencesAndPreservesMutedVolume() const;
    void validatesAudioPreferences_data() const;
    void validatesAudioPreferences() const;
    void clampsAudioVolumeAndIgnoresNonFiniteValues() const;
    void rollsBackAudioPreferencesWhenSavingFails() const;
    void storesGameplayPreferences() const;
    void validatesGameplayPreferences() const;
    void rollsBackGameplayPreferencesWhenSavingFails() const;
    void storesMusicPreferencesIndependentlyOfSoundEffects() const;
    void validatesMusicPreferences_data() const;
    void validatesMusicPreferences() const;
    void clampsMusicVolumeAndIgnoresNonFiniteValues() const;
    void normalizesMusicTrackSelection() const;
    void rollsBackMusicPreferencesWhenSavingFails() const;
