...
void sendEnvelope(QWebSocket *socket, const Envelope &env)
{
    socket->sendTextMessage(QString::fromUtf8(hexproof::protocol::serialize(env)));
}

QWebSocket *takeServerPeer(QWebSocketServer &server)
{
...
Envelope sharedFixture(const QString &name, bool *ok)
{
...
Envelope roomSnapshot(const QString &name, bool deckSelected = false, bool ready = false)
{
    Envelope env;
...
void TestWsClient::hidesMirroredSessionPropertiesFromQml() const
{
    ...
    const QStringList mirrored = {
        u"youAreHost"_s,      u"roomRole"_s,        u"seatIndex"_s,
        u"selectedDeckName"_s, u"roomId"_s,          u"roomName"_s,
        u"format"_s,          u"playtest"_s,        u"matchMode"_s,
        u"cardLoadMode"_s,    u"maxSeats"_s,        u"roomPhase"_s,
        u"loadId"_s,          u"seats"_s,           u"spectators"_s,
        u"gameNumber"_s,      u"startingSeat"_s,    u"activeSeat"_s,
        u"currentPhase"_s,    u"gameArrows"_s,      u"gameAttachments"_s,
        u"gameLog"_s,         u"matchScore"_s,      u"gameResult"_s,
...
void TestWsClient::sendsDeckAndReadyCommands() const
{
    ...
    client.resolveLibraryView(QVariantList{u"s1-c8"_s}, QVariantList{u"s1-c9"_s},
                              hexproof::protocol::kLibraryDestinationBottom, u"top"_s, false,
                              false, {}, 1, u"zone-dump-1"_s);
    QTRY_COMPARE_WITH_TIMEOUT(outbound.count(), 1, 1000);
    sent = hexproof::protocol::parse(outbound.takeFirst().first().toString().toUtf8(), &ok);
    QVERIFY(ok);
    QCOMPARE(sent.type, hexproof::protocol::kTypeGameResolveLibraryView);
