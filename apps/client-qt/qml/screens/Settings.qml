...
Page {
    ...
    ScreenHeader {
        ...
        title: qsTr("Settings")
        subtitle: qsTr("Language and local card data")
            ...
            Surface {
                ...
                ColumnLayout {
                    ...
                    InfoBanner {
                        Layout.fillWidth: true
                        tone: "warning"
                        message: preferences.cardLanguage === "zh"
                                 ? qsTr("Chinese card data prefers Scryfall Chinese art, then MTGCH, then English art.")
                                 : qsTr("English card metadata and art use Scryfall first, with MTGCH as a network fallback.")
                    }
                }
            }
    ...
    Component.onCompleted: {
        ...
        cardCatalog.checkCatalogUpdate()
    }
}
