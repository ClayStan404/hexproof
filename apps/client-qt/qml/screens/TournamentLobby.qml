...
Page {
            ...
            ColumnLayout {
                ...
                Text {
                    ...
                    text: tournament.tournamentId + " · "
                          + I18n.tournamentFormatLabel(tournament.format)
                ...
                ColumnLayout {
                    ...
                    SegmentedControl {
                        Layout.preferredWidth: Math.min(Theme.size(680),
                                                        parent.width)
                        options: tournament.status === "completed"
                        ...
                        ListView {
                            ...
                            delegate: Surface {
                                ...
                                RowLayout {
                                    ...
                                    AppButton {
                                        visible: pairingRow.modelData.status
                                                 === "reported"
                                                 && tournament.status === "running"
    ...
    ConfirmDialog {
        id: cancelDialog
        titleText: qsTr("Cancel tournament?")
        message: qsTr("The event will stop and no further rounds can be created.")
        confirmText: qsTr("Cancel tournament")
        dangerous: true
