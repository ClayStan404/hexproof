...
Page {
    ...
    ConfigurableShortcut {
        actionId: "replay.playPause"
        context: Qt.WindowShortcut
        available: root.logEntries.length > 0
        onActivated: {
    ...
    ConfigurableShortcut {
        actionId: "replay.previous"
        context: Qt.WindowShortcut
        available: root.visibleCount > 1
        onActivated: {
            root.playing = false
            root.visibleCount -= 1
        }
    ...
    ConfigurableShortcut {
        actionId: "replay.next"
        context: Qt.WindowShortcut
        available: root.visibleCount < root.logEntries.length
        onActivated: {
            root.playing = false
            root.visibleCount += 1
        }
    ...
    ConfigurableShortcut {
        actionId: "replay.speedHalf"
        context: Qt.WindowShortcut
        onActivated: root.playbackSpeed = 0.5
    }
    ConfigurableShortcut {
        actionId: "replay.speedNormal"
        context: Qt.WindowShortcut
        onActivated: root.playbackSpeed = 1
    }
    ConfigurableShortcut {
        actionId: "replay.speedDouble"
        context: Qt.WindowShortcut
        onActivated: root.playbackSpeed = 2
    }
    ConfigurableShortcut {
        actionId: "replay.speedQuadruple"
        context: Qt.WindowShortcut
