...
Page {
    ...
    ColumnLayout {
        ...
        ScreenHeader {
            ...
            subtitle: qsTr("Register, play Swiss rounds, and follow live standings")
        ...
        RowLayout {
            ...
            AppTextField {
                ...
                placeholderText: qsTr("Tournament code")
                maximumLength: 16
        ...
        Surface {
            ...
            ColumnLayout {
                ...
                Text {
                    ...
                    text: qsTr("No public tournaments are available on this hub.")
                    color: Theme.text
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            ...
                            Text {
                                textFormat: Text.PlainText
                                Layout.fillWidth: true
                                text: qsTr("%1 registered · %2 checked in · %3 rounds")
