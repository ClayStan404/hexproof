...
var commandRegistry = map[string]commandSpec{
	...
	protocol.TypeLimitedSetDraftControl:        requiredCommand((*Handler).handleLimitedSetDraftControl),
	protocol.TypeLimitedSetParticipation:       requiredCommand((*Handler).handleLimitedSetParticipation),
	protocol.TypeRoomAIConfigure:               requiredCommand((*Handler).handleRoomAIConfigure),
	...
	protocol.TypeGameCreateEmblem:              requiredCommand((*Handler).handleGameCreateEmblem),
	protocol.TypeGameRemoveEmblem:              requiredCommand((*Handler).handleGameRemoveEmblem),
	...
	protocol.TypeSideboardChooseStartingPlayer: requiredCommand((*Handler).handleSideboardChooseStartingPlayer),
	protocol.TypeGameSetLibraryTopRevealed:     requiredCommand((*Handler).handleGameSetLibraryTopRevealed),
	...
	protocol.TypeForgeReplayGet:                requiredCommand((*Handler).handleForgeReplayGet),
}
