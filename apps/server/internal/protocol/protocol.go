...
// RoomSnapshot is the payload of room.snapshot (S->C). Projected per role:
// all snapshots carry counts + public structure; private zones (P3+) add
// identities only for the owning viewer.
